(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        try {
            var legacy = localStorage.getItem(window.MEDXONE.TOKEN_KEY);
            if (legacy && !sessionStorage.getItem(window.MEDXONE.TOKEN_KEY)) {
                sessionStorage.setItem(window.MEDXONE.TOKEN_KEY, legacy);
            }
        ...
        // Auto-logout: clear token when the tab/window is being closed.
        // sessionStorage already clears on close, but this handles edge
        // cases like the browser keeping sessionStorage alive on restore.
